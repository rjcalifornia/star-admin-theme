...
<section class="features-overview" id="features-section" >
        <div class="content-header">
          <h2>About</h2>
          <h6 class="section-subtitle text-muted">Elgg is an open source social networking engine for
              <br>building communication tools for companies and organizations.</h6>
        </div>
        <div class="d-md-flex justify-content-between">
          <div class="grid-margin d-flex justify-content-start">
            <div class="features-width">
                <img src="<?php echo $site_url?>mod/star-admin-theme/graphics/api.svg" alt="" class="img-icons" width="64">
              <h5 class="py-3">Well-documented <br> core API</h5>
              <p class="text-muted">
          ...
          <div class="grid-margin d-flex justify-content-center">
            <div class="features-width">
              <img src="<?php echo $site_url?>mod/star-admin-theme/graphics/unauthorized-person.svg" alt="" class="img-icons" width="64">
